...
fluidsynth -nli -r 48000 -o synth.cpu-cores=8 -T wav -F out_organ.wav -g 0.75 $(get_script_dir)/../soundfonts/BureaFuneralChapel.sf2 out_organ.mid
fluidsynth -nli -r 48000 -o synth.cpu-cores=8 -T wav -F out_acc.wav -g 0.75 $(get_script_dir)/../soundfonts/GeneralUser\ GS\ v1.471.sf2 out_acc.mid
